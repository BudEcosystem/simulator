...
from llm_memory_calculator.genz.cpu.operator_enhancement import enhance_operators_for_cpu, restore_original_operators
...
def enable_cpu_aware_inference():
    ...
    """
    import llm_memory_calculator.genz.LLM_inference.llm_prefill as prefill_module
