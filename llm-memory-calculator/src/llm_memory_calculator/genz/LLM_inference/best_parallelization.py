...
from llm_memory_calculator.genz.operator_base import op_type_dicts
...
try:
    ...
    HAS_PARETOSET = False
    import warnings
    warnings.warn("paretoset not available. get_pareto_optimal_performance will not be available.", ImportWarning)
...
def get_pareto_optimal_performance(
    ...
    if not HAS_PARETOSET:
        raise ImportError("paretoset package is required for get_pareto_optimal_performance. "
