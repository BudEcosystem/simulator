...
import { Calculator, Settings, BarChart3, Package, ArrowLeft, ArrowRight, AlertCircle, CheckCircle, Loader2, Database, HardDrive, Cpu, Zap, Eye, GitBranch, Hash, Brain, ChevronDown, ChevronUp, Info, Save, FileText, Layers, Search, Star, Download, Filter, X, Send, Upload, Clock, Home, GitCompare, Sparkles, ExternalLink, RefreshCw, TrendingUp, Briefcase } from 'lucide-react';
...
const AIMemoryCalculator = () => {
  ...
  */
  ...
  const handleUsecaseSelect = (usecaseId: string) => {
    ...
    setCurrentScreen('usecase-detail');
  };

  const handleUsecaseBack = () => {
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex space-x-1">
            {[
              ...
              { id: 'usecases', label: 'Usecases', icon: Briefcase },
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      {currentScreen === 'usecases' && (
        <UsecaseList onUsecaseSelect={handleUsecaseSelect} />
      )}
      {currentScreen === 'usecase-detail' && selectedUsecaseId && (
        <UsecaseDetail
          usecaseId={selectedUsecaseId}
          onBack={handleUsecaseBack}
        />
      )}
