...
class CPUSystem:
    ...
    def get_effective_bandwidth(self, data_location: str, accessing_core: int) -> float:
        """Get effective bandwidth considering cache level and NUMA"""
        if data_location == 'L1':
